<template>
  <div class="relative" v-click-outside="onClickOutside">
    ...
    >{{text}}</IButton>
    <div
      class="flex bg-white flex-row items-center justify-center pb-8 pt-12 px-4 absolute z-50 bottom-rounded w-full top-50 transition duration-100 ease-in-out duration-100"
...
@Component({
  components: { PrivateKeyModal, IButton },
